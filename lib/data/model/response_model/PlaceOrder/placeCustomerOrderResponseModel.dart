class PlaceCustomerOrderResponseModel {
  bool? success;
  String? message;
  Data? data;

  PlaceCustomerOrderResponseModel({this.success, this.message, this.data});

  PlaceCustomerOrderResponseModel.fromJson(Map<String, dynamic> json) {
