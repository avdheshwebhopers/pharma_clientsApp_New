...
class FavouriteProductResponseModel {
  ...
  FavouriteProductResponseModel({this.success, this.message, this.data});

  FavouriteProductResponseModel.fromJson(Map<String, dynamic> json) {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['packingVarient'] != null) {
      ...
      json['packingVarient'].forEach((v) {
        packingVarient!.add(new PackingVarient.fromJson(v));
      });
    }
