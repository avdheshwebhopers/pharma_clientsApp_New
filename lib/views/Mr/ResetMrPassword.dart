...
import '../../data/model/requested_data_model/forgotPassword/ResetPasswordEntity.dart';
...
class ResetMrPasswordScreen extends StatefulWidget {
  const ResetMrPasswordScreen({
    this.id,
  ...
  @override
  State<ResetMrPasswordScreen> createState() => _ResetMrPasswordScreenState();
}

class _ResetMrPasswordScreenState extends State<ResetMrPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final provider = Provider.of<ResetMrPasswordViewModel>(context);
      ...
      body: Form(
        ...
        child: Column(
          children: [
           ...
           Consumer<ResetMrPasswordViewModel>(
